# c64-https — engineering notes (full history)


This is the unabridged former CLAUDE.md: every measurement, failed hypothesis
and post-mortem, kept verbatim. The terse reference is the repo-root
`CLAUDE.md`; come here when it says "see engineering-notes". Section names
below match the ones CLAUDE.md cites.
