...
# see src/constants.inc). HTTP_REU_BODY_BASE=<decimal> overrides the
# base (ca65 -D takes no 0x and $ needs shell quoting): e.g.
# `make HTTP_REU_BODY_BASE=196608` targets bank 3 for a 512 KB VICE REU.
