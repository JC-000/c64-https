; =============================================================================
; tls_transcript.asm - Streaming SHA-256 transcript hash for TLS 1.3
; =============================================================================
...
;   tls_rec_idx ($20)  - block position index during copy
;
; External dependencies (sha256.asm / data.asm):
;   sha256_init, sha256_process_block, sha256_final
;   sha256_h0..h7, sha256_block, sha256_hash
;   tls_transcript, tls_transcript_h0..h7
; =============================================================================

; =============================================================================
; Local data buffers
; =============================================================================
tls_transcript_block:     !fill 64, 0   ; partial block buffer
tls_transcript_block_len: !byte 0       ; bytes in current partial block (0-63)
tls_transcript_total_lo:  !byte 0       ; total bytes hashed (low byte)
tls_transcript_total_hi:  !byte 0       ; total bytes hashed (high byte)

; Temporary save area for tls_transcript_hash (32 bytes)
; Used to preserve running state during non-destructive finalization
tls_transcript_save:      !fill 32, 0
