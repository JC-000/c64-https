...
;   - fe_mul: REU DMA table lookup + 2x inner loop unroll (no mul_8x8 calls)
...
;   - fe_cswap: Self-modifying abs,Y + 4x unroll (38 cyc/byte vs 49)
;
...
; Uses mul38 lookup tables for speed.
; Clobbers: A, X, Y
; =============================================================================
fe_reduce_wide:
