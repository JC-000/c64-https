...
tcp_recv_overflow:  .res 1      ; set to 1 by the backend if the ring
                                ; fills: ACKed bytes lost for good. The
                                ; old ip65 "retransmit burst" reading was
                                ; ip65's FIN/RST length $FFFF copied as
                                ; data on every close; net_tcp_recv_cb
                                ; now drops it. See the
                                ; set-site comment in src/net/ip65/net.s.
